...
<body>
	...
	<s:param name="productId" value="%{productId}"/>
									...
									class="item-image-box-200" /></a><br> <s:property
			...
			<div class="pager">
				<s:iterator begin="1" end="#session.totalPageSize" status="pageNo">
					...
					<s:else>
						<a
							href="<s:url action='SearchItemAction'><s:param name='pageNo' value='%{#pageNo.count}'/><s:param name='categoryId' value='%{categoryId}'/><s:param name='keywords' value='%{keywords}'/></s:url> ">
							<s:property value="%{#pageNo.count}" />
						</a>
					</s:else>
				</s:iterator>
